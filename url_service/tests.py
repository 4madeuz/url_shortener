...
@pytest.mark.asyncio
async def test_get_urls(test_client: AsyncClient):
...
@pytest.mark.asyncio
async def test_get_short_url(test_client: AsyncClient, sample_url: URL):
...
@pytest.mark.asyncio
async def test_get_by_id(test_client: AsyncClient, sample_url: URL):
